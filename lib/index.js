  ...
  return function (_Component) {
    ...
    function MediaQuery() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MediaQuery.__proto__ || Object.getPrototypeOf(MediaQuery)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        params: {}
      }, _this.containerResizeObserver = null, _this.matchQueries = (0, _helpers.matchQueries)(BREAKPOINTS), _this.handleWindowResize = function (e) {
    ...
    _createClass(MediaQuery, [{
      ...
      value: function componentDidMount() {
        ...
        if (viewport) {
          ...
          this.containerResizeObserver = new _resizeObserverPolyfill2.default(this.handleContainerResize);
          this.containerResizeObserver.observe(container);
          initialWidth = (0, _helpers.getWidth)(container);
          console.log('container initialWidth \u2192 ' + initialWidth);
        }

        var result = this.matchQueries(initialWidth);
        console.log(result);
